        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('status')
                    ->options([
                        'Kepala Program Studi Matematika' => 'Kepala Program Studi Matematika',
                        'Dosen' => 'Dosen',
                        'Staff' => 'Staff',
                    ])
                    ->reactive()
                ...
                ->visible(fn (Get $get) => $get('status') === 'Kepala Program Studi Matematika') 
                ->required(fn (Get $get): bool => $get('status') === 'Kepala Program Studi Matematika')
                ->columnSpanFull(),
            ]);
    }
